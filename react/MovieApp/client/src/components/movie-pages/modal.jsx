...
import { withFormik, Field, FieldArray 
        } from 'formik'
    ...
    return (
      <div className="inline-radio">
        <input
          ...
          {...props}
        />
        <label className="toggle__label" htmlFor={id}>{label}</label>
      </div>
    );
  };
...
const ModalForm = (props) => {
    ...
    <div className="fill-form">
      <form onSubmit={handleSubmit}>
          <p>Hi User,</p>
            <p>Your film <label htmlFor="title">title </label> is 
              <input
                id="title"
                ...
                <p>it <label htmlFor="year">was filmed</label> in
                  <input
                    id="year"
                    placeholder="(year)"
                    type="text"
