  ...
  return (
    ...
    <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
            <div className="movie-content__front">
                    <div className="movie-content__front--inner">
                        ...
                        <h1 className="movie-content__front--title">{title}</h1>
                            ...
                            <button className="movie-content__front--details" onClick={handleClick}>Details</button>
                            <button
            ...
            <div className="movie-content__inner">
                   ...
                   <button className="button movie-content__front--details" onClick={handleClick}>Click to flip</button>
            </div>
    </ReactCardFlip>
    </div>
    </div>
